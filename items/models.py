...
class CartProcessOrders(models.Model) :
    ...
    color               = models.ForeignKey(ProductAttachment, on_delete=models.SET_NULL, blank=True, null=True, related_name="product_cart_color")
    size_number         = models.ForeignKey(ProductAttachment, on_delete=models.SET_NULL, blank=True, null=True, related_name="product_cart_size_number")
    size                = models.ForeignKey(ProductAttachment, on_delete=models.SET_NULL, blank=True, null=True, related_name="product_cart_size")
    quantity            = models.PositiveIntegerField(default=0)
    total_price         = models.DecimalField(max_digits=20,decimal_places=2, blank=True, null=True)
    transection_id      = models.CharField(blank=True, null=True, max_length=25)
    updated             = models.DateTimeField(auto_now_add=True)
